  ...
  return (
    <>
      <div className="relative w-full h-[100vh] xl:h-[85vh] flex flex-col xl:flex-row items-center bg-bg-hero justify-end xl:justify-between overflow-hidden">
        <div className="absolute top-[6rem] xxs:top-[4rem] xs:top-[5rem] sm:top-[12rem] mdx:top-[3rem] w-full xs:w-[30rem] md:w-3/4 xl:w-3/5 xl:h-full pl-[1rem] xl:pl-[8rem] xl:static flex items-center justify-start xl:flex-col xl:items-start xl:justify-between xl:pt-[26rem] xl:pb-[4rem] ">
        ...
        <div className="absolute bottom-0 right-0 xl:w-2/5 w-full flex justify-center items-end xl:items-center">
          <img
            ...
            alt="Hero Ryan"
            className="w-full xs:w-[500px] sm:w-[600px] md:w-[650px] xl:w-[600px] 2xl:w-[700px] -mb-[2rem] xl:-mb-[6rem] aspect-[3/4]"
          />
        </div>
      </div>
    </>
